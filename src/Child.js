...
export default function Child(props) {
    ...
    'За все будет расплата, и за хорошее, и за плохое',
    ...
    'В конце концов, мы ждем именно такого человека... Который сам приходит, когда необходим... Которого никогда не нужно просить...',
    'Не позволяйте негативным и токсичным людям занимать место в своей голове. Поднимите арендную плату и выгоните их.',
    'Мир полон чудесных вещей, терпеливо ожидающих, пока наши чувства обострятся.',
    'Не совершай классическую ошибку всех умников: не думай, что нет людей умнее тебя.',
    'Безвыходным мы называем положение, выход из которого нам не нравится',
    'Вы задаете очень много вопросов. Поэтому дальнейшее гадание будет недействительным'
    ]
